...
export class UIScene extends Scene {
    ...
    create() {
        ...
        this.leftButton = this.add.text(this.windowWidth * 0.4, this.windowHeight * .95, '👈').setInteractive();
        this.leftButton.on('pointerdown', () => this.boat.setTurnLeft(true));
        this.rightButton = this.add.text(this.windowWidth * 0.6, this.windowHeight * .95, '👉').setInteractive();
        this.rightButton.on('pointerdown', () => this.boat.setTurnRight(true));
        this.goStraightButton = this.add.text(this.windowWidth * 0.5, this.windowHeight * .92, '👆').setInteractive();
